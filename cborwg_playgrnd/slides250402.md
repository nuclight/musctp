...
 
### - e.g. for DNS: to replace cobra-packed, matching it's goals
 
---
# Goals / Rationale
 
...
 
---
# cbor-packed problems - DNS example from [draft-lenders], 1/3
 
...
 
# cbor-packed problems - DNS example from [draft-lenders], 2/3
